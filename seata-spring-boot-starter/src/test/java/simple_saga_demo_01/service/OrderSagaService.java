...
public class OrderSagaService {
     ...
     * 创建订单 - Saga正向操作
     */
    @CompensationBusinessAction(name = "createOrder", compensationMethod = "compensateCreateOrder")
     ...
     * 扣减库存 - Saga正向操作
     */
    @CompensationBusinessAction(name = "deductInventory", compensationMethod = "compensateDeductInventory")
     ...
     * 扣减账户余额 - Saga正向操作
     */
    @CompensationBusinessAction(name = "deductAccount", compensationMethod = "compensateDeductAccount")
